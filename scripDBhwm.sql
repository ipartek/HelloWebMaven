...
INSERT INTO `persona` (`id`, `nombre`, `email`) VALUES
	(1, 'jose', 'jose@jose.com'),
	(2, 'alaberto', 'alberto@alberto.com'),
	(3, 'irati', 'irati@irati.com');
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='Pl';

-- Volcando datos para la tabla hwm.planet: ~5 rows (aproximadamente)
DELETE FROM `planet`;
...
INSERT INTO `planet` (`id`, `nombre`, `imagen`) VALUES
	...
	(14, 'nuevoplaneta', 'http://icdn.pro/images/en/a/s/astroid-moon-planet-icone-5626-128.png');
